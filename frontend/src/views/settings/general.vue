<template>
  <div class="items">
    ...
    <b-field :label="$t('settings.general.rootURL')" label-position="on-border"
      ...
      <b-input v-model="data['app.root_url']" name="app.root_url" placeholder="https://mail.yoursite.com"
    ...
    <div class="columns">
      <div class="column is-6">
        <b-field :label="$t('settings.general.logoURL')" label-position="on-border"
          ...
          <b-input v-model="data['app.logo_url']" name="app.logo_url" placeholder="https://mail.yoursite.com/logo.png"
      ...
      <div class="column is-6">
        <b-field :label="$t('settings.general.faviconURL')" label-position="on-border"
          ...
          <b-input v-model="data['app.favicon_url']" name="app.favicon_url"
            placeholder="https://mail.yoursite.com/favicon.png" :maxlength="300"
