...
INSERT INTO settings (key, value) VALUES
    ...
    ('app.favicon_url', '""'),
    ('app.from_email', '"IKEMEN MAILER <noreply@mail.yoursite.com>"'),
    ('app.logo_url', '""'),
    ('app.concurrency', '10'),
    ('app.message_rate', '10'),
    ('app.batch_size', '1000'),
    ...
    ('bounce.mailboxes',
        '[{"enabled":false, "type": "pop", "host":"pop.yoursite.com","port":995,"auth_protocol":"userpass","username":"username","password":"password","return_path": "bounce@mail.yoursite.com","scan_interval":"15m","tls_enabled":true,"tls_skip_verify":false}]'),
